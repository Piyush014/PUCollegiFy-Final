...
// import 'package:cloud_firestore/cloud_firestore.dart';
//
// typedef void ProfileUpdatedCallback(Map<String, dynamic> updatedData);
//
// class EditUserProfile extends StatefulWidget {
//   final ProfileUpdatedCallback? onProfileUpdated;
//
//   EditUserProfile({this.onProfileUpdated});
//
//   @override
//   _EditUserProfileState createState() => _EditUserProfileState();
// }
...
//       if (currentUser != null) {
//         final snapshot = await FirebaseFirestore.instance
//             .collection('users') // Change this to your users collection name
//             .doc(currentUser.uid)
//             .get();
//
//         if (snapshot.exists) {
...
//         // Parse the previous image URL to extract the file name
//         final previousFileName = pickedProfileImage!.split('/').last;
//         final previousImageRef = fbs.FirebaseStorage.instance
//             .ref('userProfiles/${currentUser!.uid}/$previousFileName');
//
...
//         'email': emailController!.text,
//         'phone': phoneController!.text,
//         'profile_image': pickedProfileImage,
//       });
//
//       setState(() {
//         processing = false;
...
//       );
//
//       // Invoke the callback to notify the ProfileScreen of the update
...
//       }
//
//       // Close the EditUserProfile page
